        ...
        <>
            {item.characteristics.collection === 'line' && item.type === 't-shirts' ? (
                <li className={styles.list__item_ad}>
                    ...
                    >
                        <span className={`${adStyles.ad} ${styles.list__item_ad__ad}`}>
                ...
                <li className={styles.list__item}>
                    ...
                    <div className={styles.list__item__inner}>
                        ...
                        />
                        <span className={styles.list__item__price}>{formatPrice(+item.price)} ₴</span>
                    </div>
                    <button className={`btn-reset ${styles.list__item__cart}`}>{translations[lang].product.to_cart}</button>
                </li>
            )}
        </>
    );
