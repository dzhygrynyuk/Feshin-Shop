...
import { nameValidationRules } from "@/libs/utils/auth";
    ...
    return (
        <div className='form__block'>
            <input
                ...
                {...register(
                    'name',
                    nameValidationRules(translations[lang].validation.invalid_value, translations[lang].validation.requiredName)
                )}
            />
            <NameErrorMessage
                errors={errors}
