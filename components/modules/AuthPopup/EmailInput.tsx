...
import { emailValidationRules } from "@/libs/utils/auth";
    ...
    return (
        <div className='form__block'>
            <input 
                ...
                {...register(
                    'email',
                    emailValidationRules(translations[lang].validation.invalid_email, translations[lang].validation.required_email)
                )}
            />
            {errors.email && (
